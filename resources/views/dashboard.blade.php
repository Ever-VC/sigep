...
@section('contenido')
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4" onclick="">
            <div class="bg-blue-100 p-4 rounded shadow">
                ...
                <a href="{{ route('employees.index') }}" class="mt-2 inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                Ver Empleados
                </a>
            </div>
